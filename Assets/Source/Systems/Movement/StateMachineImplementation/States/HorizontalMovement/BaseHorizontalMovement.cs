    ...
    IFinalizeState
{
    ...
    {
        Settings.rb = stateMachine.GetComponent<Rigidbody>();
    ...
    {
        Transform cameraTransform = globalData.GetValue<Transform>("CameraTransform").Value;
        ...
        globalData.SetValue(new Vector3Property{Name="HorizontalMovement", Value=motionVector * Settings.linearSpeed});
